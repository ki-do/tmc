...
func (t *TmcRepo) Index(context.Context, ...string) (authorsList, manufacturersList, mpnsList, protocolsList []string, err error) {
	return nil, nil, nil, nil, nil // ignore request to update index as index updates are presumed to be handled by the underlying repo
}
