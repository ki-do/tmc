...
func TestCopy(t *testing.T) {
	...
	t.Run("with ok", func(t *testing.T) {
		...
		target.On("Index", mock.Anything, tmID_1, tmID_2, tmID_3).Return([]string{}, []string{}, []string{}, []string{}, nil)
		target.On("Index", mock.Anything, tmID_1).Return([]string{}, []string{}, []string{}, []string{}, nil)
		target.On("Index", mock.Anything, tmID_2).Return([]string{}, []string{}, []string{}, []string{}, nil)
		target.On("Index", mock.Anything, tmID_3).Return([]string{}, []string{}, []string{}, []string{}, nil)
	...
	t.Run("with error fetching an attachment", func(t *testing.T) {
		...
		target.On("Index", mock.Anything, tmid).Return([]string{}, []string{}, []string{}, []string{}, nil).Twice()
