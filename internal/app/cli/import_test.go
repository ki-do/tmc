...
func TestImportExecutor_Import(t *testing.T) {
	...
	t.Run("import when none exists", func(t *testing.T) {
		...
		r.On("Index", mock.Anything, id).Return([]string{}, []string{}, []string{}, []string{}, nil)
...
func TestImportExecutor_Import_Directory(t *testing.T) {
	...
	t.Run("import directory", func(t *testing.T) {
		...
		r.On("Index", mock.Anything,
			...
			"omnicorp-tm-department/omnicorp/omnilamp/v0.0.0-20231110123244-575dfac219e2.tm.json").Return([]string{}, []string{}, []string{}, []string{}, nil)
	...
	t.Run("import directory with optPath", func(t *testing.T) {
		...
		r.On("Import", mock.Anything, tmid, mock.Anything, opts).Return(repos.ImportResult{Type: repos.ImportResultOK, TmID: tmid.String()}, nil)
		r.On("Index", mock.Anything, id1, id2, id3, id4).Return([]string{}, []string{}, []string{}, []string{}, nil)
	...
	t.Run("import directory with with-attachments", func(t *testing.T) {
		...
		tmid1 := model.MustParseTMID("omnicorp-tm-department/omnicorp/omnilamp/v3.2.1-20231110123243-98b3fbd291f4.tm.json")
		...
		r.On("Index", mock.Anything).Return([]string{}, []string{}, []string{}, []string{}, nil)
		r.On("Index", mock.Anything, tmid1.String(), tmid2.String()).Return([]string{}, []string{}, []string{}, []string{}, nil)
